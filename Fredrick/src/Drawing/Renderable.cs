...
namespace Fredrick.src
{
	public class Renderable : Component
	{
		...
		public override void Draw(SpriteBatch spriteBatch)
		{
			...
			spriteBatch.Draw(_d._sprite, (_position + _owner.GetPosition()) * inv * _d._spriteSize, _d._sourceRectangle, _d._colour, _rotation, _d._origin, _scale, _d._spriteEffects, _d._layer);
		}
